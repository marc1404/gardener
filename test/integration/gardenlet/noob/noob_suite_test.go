...
func TestState(t *testing.T) {
	...
	RunSpecs(t, "Test Integration Gardenlet Noob State Suite")
}

const testID = "noob-controller-test"
...
var _ = BeforeSuite(func() {
	...
	Expect((&noob.Reconciler{
		SeedClient:         testClient,
		GardenClient:       testClient,
		GardenClusterCache: mgr.GetCache(),
		GardenNamespace:    testRunID,
